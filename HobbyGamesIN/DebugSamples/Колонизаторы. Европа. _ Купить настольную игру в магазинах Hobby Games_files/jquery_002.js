...
;(function (root) {
    var factory = (function (window, document, $, undefined) {
        ...
        window.APP.addStyle('/assets/js/checkout/lib/fancybox/jquery.fancybox.css');
        window.APP.addStyle('/assets/js/checkout/lib/fancybox/helpers/jquery.fancybox-thumbs.css');
